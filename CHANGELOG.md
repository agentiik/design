...
The tokens, the type roles, the icons and the written guidance every client wears. The roadmap says which release fills this repository: <https://agentiik.github.io/docs/roadmap>.
